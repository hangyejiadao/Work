                     ...
                     eliss.ForEach(p =>
                      {
                          try
                          {
                              ...
                              if (time > DateTime.Now.AddMonths(-2))
                              {
                                  ...
                                  IElement areasize = documentE.QuerySelectorAll("span")
                                  ...
                                  var addressDetail = documentE.QuerySelectorAll("span").FirstOrDefault(o =>
                                      o.ClassName == "house_basic_title_content_item3 xxdz-des");

                                  var IndustryName = documentE.QuerySelectorAll("span")
                                      .Where(o => o.ClassName == "house_basic_title_content_item3").ToList()[2];
                                  ...
                                  var shoptransfer = new ShopRentOrTransfer()
                                  {
                                      ...
                                      Address = string.Join("", address.Select(i => i.InnerHtml)),
